...
/**
* The implementation file for type MSOneNoteApiSectionCollectionFetcher.
*/
...
- (MSOneNoteApiSectionFetcher *)getById:(NSString *)Id {
    ...
    return [[MSOneNoteApiSectionFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
