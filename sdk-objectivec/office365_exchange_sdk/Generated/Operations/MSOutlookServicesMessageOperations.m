...
/**
* The implementation file for type MSOutlookServicesMessageOperations.
*/

@implementation MSOutlookServicesMessageOperations
...
- (NSURLSessionTask *)copyWithDestinationId:(NSString *)destinationId callback:(void (^)(MSOutlookServicesMessage *message, MSODataException *exception))callback {
	...
	NSURLSessionTask *task = [self copyRawWithDestinationId:destinationIdString callback:^(NSString *returnValue, MSODataException *exception) {
	   ...
	   if (exception == nil) {
			...
			MSOutlookServicesMessage * result = (MSOutlookServicesMessage *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[MSOutlookServicesMessage class]];
...
- (NSURLSessionTask *)createReplyAllWithCallback:(void (^)(MSOutlookServicesMessage *message, MSODataException *exception))callback {
