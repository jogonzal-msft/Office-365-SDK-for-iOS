...
/**
* The implementation file for type MSOutlookServicesCalendarGroupCollectionFetcher.
*/

@implementation MSOutlookServicesCalendarGroupCollectionFetcher
...
- (MSOutlookServicesCalendarGroupFetcher *)getById:(NSString *)Id {
    ...
    return [[MSOutlookServicesCalendarGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
