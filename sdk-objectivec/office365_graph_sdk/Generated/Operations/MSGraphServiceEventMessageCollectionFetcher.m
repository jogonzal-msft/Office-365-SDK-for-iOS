...
/**
* The implementation file for type MSGraphServiceEventMessageCollectionFetcher.
*/
...
- (MSGraphServiceEventMessageFetcher *)getById:(NSString *)Id {
    ...
    return [[MSGraphServiceEventMessageFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
