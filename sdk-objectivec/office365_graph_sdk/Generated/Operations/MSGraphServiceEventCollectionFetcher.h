...
- (id<MSGraphServiceEventCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceEvent *)entity callback:(void (^)(MSGraphServiceEvent *event, MSODataException *e))callback;
