...
- (id<MSGraphServiceFolderCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceFolder *)entity callback:(void (^)(MSGraphServiceFolder *folder, MSODataException *e))callback;
