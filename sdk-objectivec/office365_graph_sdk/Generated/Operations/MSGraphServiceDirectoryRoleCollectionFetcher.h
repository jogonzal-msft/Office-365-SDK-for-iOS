...
- (NSURLSessionTask *)readWithCallback:(void (^)(NSArray<MSGraphServiceDirectoryRole> *directoryRoles, MSODataException *exception))callback;
...
- (id<MSGraphServiceDirectoryRoleCollectionFetcher>)search:(NSString *)params;
...
- (id<MSGraphServiceDirectoryRoleCollectionFetcher>)addCustomParametersWithName:(NSString *)name value:(id)value;
- (id<MSGraphServiceDirectoryRoleCollectionFetcher>)addCustomHeaderWithName:(NSString *)name value:(NSString *)value;

@required

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSODataExecutable>)parent;
- (MSGraphServiceDirectoryRoleFetcher *)getById:(NSString *)Id;
- (NSURLSessionTask *)add:(MSGraphServiceDirectoryRole *)entity callback:(void (^)(MSGraphServiceDirectoryRole *directoryRole, MSODataException *e))callback;
