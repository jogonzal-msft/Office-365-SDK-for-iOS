...
- (id<MSGraphServiceCalendarCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceCalendar *)entity callback:(void (^)(MSGraphServiceCalendar *calendar, MSODataException *e))callback;
