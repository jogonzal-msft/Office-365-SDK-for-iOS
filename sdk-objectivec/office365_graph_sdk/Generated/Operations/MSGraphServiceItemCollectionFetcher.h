...
- (id<MSGraphServiceItemCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceItem *)entity callback:(void (^)(MSGraphServiceItem *item, MSODataException *e))callback;
