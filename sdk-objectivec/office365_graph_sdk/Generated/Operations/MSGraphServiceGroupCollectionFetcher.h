...
- (id<MSGraphServiceGroupCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceGroup *)entity callback:(void (^)(MSGraphServiceGroup *group, MSODataException *e))callback;
