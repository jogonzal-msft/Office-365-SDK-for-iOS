...
- (id<MSGraphServiceFileCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceFile *)entity callback:(void (^)(MSGraphServiceFile *file, MSODataException *e))callback;
