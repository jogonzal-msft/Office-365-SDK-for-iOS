...
- (id<MSGraphServiceMessageCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceMessage *)entity callback:(void (^)(MSGraphServiceMessage *message, MSODataException *e))callback;
