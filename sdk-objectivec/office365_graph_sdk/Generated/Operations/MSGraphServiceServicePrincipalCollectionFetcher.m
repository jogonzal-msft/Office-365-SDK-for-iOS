...
- (NSURLSessionTask *)add:(MSGraphServiceServicePrincipal*)entity callback:(void (^)(MSGraphServiceServicePrincipal *servicePrincipal, MSODataException *exception))callback {
