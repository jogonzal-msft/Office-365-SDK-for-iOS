...
- (NSURLSessionTask *) update:(MSGraphServiceDirectoryRole *)directoryRole callback:(void (^)(MSGraphServiceDirectoryRole *directoryRole, MSODataException *error))callback;
