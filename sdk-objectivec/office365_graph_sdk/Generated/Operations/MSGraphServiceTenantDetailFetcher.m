...
@implementation MSGraphServiceTenantDetailFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSODataExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServiceTenantDetail class]]) {

		_operations = [[MSGraphServiceTenantDetailOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }
