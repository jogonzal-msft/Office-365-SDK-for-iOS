...
- (id<MSGraphServiceDriveCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceDrive *)entity callback:(void (^)(MSGraphServiceDrive *drive, MSODataException *e))callback;
