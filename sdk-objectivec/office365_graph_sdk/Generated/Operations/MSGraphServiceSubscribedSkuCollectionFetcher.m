...
- (NSURLSessionTask *)add:(MSGraphServiceSubscribedSku*)entity callback:(void (^)(MSGraphServiceSubscribedSku *subscribedSku, MSODataException *exception))callback {
...
- (MSGraphServiceSubscribedSkuFetcher *)getById:(NSString *)Id {
    ...
    return [[MSGraphServiceSubscribedSkuFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
