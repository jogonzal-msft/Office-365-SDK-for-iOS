...
- (NSURLSessionTask *)add:(MSGraphServiceContact*)entity callback:(void (^)(MSGraphServiceContact *contact, MSODataException *exception))callback {
...
- (MSGraphServiceContactFetcher *)getById:(NSString *)Id {
    ...
    return [[MSGraphServiceContactFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
