...
/**
* The header for type MSGraphServiceMessageOperations.
*/
...
- (NSURLSessionTask *)createReplyWithCallback:(void (^)(MSGraphServiceMessage *message, MSODataException *exception))callback;
- (NSURLSessionTask *)createReplyRawWithCallback:(void(^)(NSString *returnValue, MSODataException *exception))callback;
- (NSURLSessionTask *)createReplyAllWithCallback:(void (^)(MSGraphServiceMessage *message, MSODataException *exception))callback;
- (NSURLSessionTask *)createReplyAllRawWithCallback:(void(^)(NSString *returnValue, MSODataException *exception))callback;
- (NSURLSessionTask *)createForwardWithCallback:(void (^)(MSGraphServiceMessage *message, MSODataException *exception))callback;
