...
- (id<MSGraphServiceUserCollectionFetcher>)search:(NSString *)params;
...
- (NSURLSessionTask *)add:(MSGraphServiceUser *)entity callback:(void (^)(MSGraphServiceUser *user, MSODataException *e))callback;
