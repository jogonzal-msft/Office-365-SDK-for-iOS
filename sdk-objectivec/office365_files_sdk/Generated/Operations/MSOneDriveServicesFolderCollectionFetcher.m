...
/**
* The implementation file for type MSOneDriveServicesFolderCollectionFetcher.
*/

@implementation MSOneDriveServicesFolderCollectionFetcher
...
- (MSOneDriveServicesFolderFetcher *)getById:(NSString *)Id {
    ...
    return [[MSOneDriveServicesFolderFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,Id] parent:self];
}
